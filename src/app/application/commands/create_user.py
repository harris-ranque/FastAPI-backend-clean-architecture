...
class CreateUserInteractor:
    ...
    async def execute(self, request_data: CreateUserRequest) -> CreateUserResponse:
        ...
        """
        log.info(f"Create user: started. Target username: '%s'.", request_data.username)
        ...
        self._user_command_gateway.create(user)
        ...
        log.info(f"Create user: done. Target username: '%s'.", user.username.value)

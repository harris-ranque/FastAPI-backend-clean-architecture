...
class BcryptPasswordHasher(PasswordHasher):
    def __init__(
        ...
        semaphore_wait_timeout: float,
    ) -> None:
        self._pepper = pepper
        self._work_factor = work_factor
        self._executor = executor
        self._semaphore = semaphore
        self._semaphore_wait_timeout = semaphore_wait_timeout
    ...
    async def _permit(self) -> AsyncIterator[None]:
        ...
        try:
            await asyncio.wait_for(
                ...
                timeout=self._semaphore_wait_timeout,
            )
    ...
    @staticmethod
    def _add_pepper(self, raw_password: RawPassword, pepper: bytes) -> bytes:
